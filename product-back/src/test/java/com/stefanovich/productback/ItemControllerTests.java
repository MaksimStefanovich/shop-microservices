...
// TODO PageImpl with default page and size
  ...
  void getAllItems_whenFirstFilter_thenGetMatchItems() {
    ...
    PageDto<Item> itemPage =new PageDto<>( new PageImpl<>(List.of(item1)));
  ...
  void getAllItems_whenSecondFilter_thenGetMatchItems() {
    ...
    PageDto<Item> itemPage =new PageDto<>( new PageImpl<>(List.of(item2)));
  ...
  void getAllPages_whenNoFilters_thenGetMatchItems() {
    ItemSearchFilterDto itemSearchFilterDto = new ItemSearchFilterDto();
    itemSearchFilterDto.setPage(0);
    itemSearchFilterDto.setSize(1);
    PageDto<Item> itemPage = new PageDto<>(new PageImpl(List.of(item1)));
  ...
  //todo without page and size

  @Test
  @SneakyThrows
  void getAllPages_whenNoFiltersAndSetPages_thenGetMatchItems() {
    ItemSearchFilterDto itemSearchFilterDto = new ItemSearchFilterDto();
    when(itemService.getAllItemsByFilters(itemSearchFilterDto)).thenReturn(items);
